...
class ControlLoop : protected PBIC{
    ...
    protected:
        ...
        // ==========================================================================
        // 임피던스 구현 선택. 여기 한 곳에서만 바꾼다.
        //   kPBIC_TDC : MotionGenerator + ControlGenerator (PBIC-TDC)
        //   kDBIC     : ControlGeneratorDBIC
        // 도형 그리기(waypoint / draw_mode / 접촉 hold / MLP 외력)는 양쪽 다 동작한다.
        // ==========================================================================
